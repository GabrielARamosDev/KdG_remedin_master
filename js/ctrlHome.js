				...
				geocoder.geocode({ 'latLng': latlng }, function (results, status) {
					if (status == google.maps.GeocoderStatus.OK) {
						if (results[1]) {
							...
							localStorage.setItem('endereco',estouAqui);

							//for( i=0; i<15; i++) {
								//if(obj.address_components[i].type[0]="postal_code") {
								//	var cep = obj.address_components[i].short_name;
								//	console.log(cep);
								//}
							//}

							if(obj.address_components[5].types[0]="postal_code") {
								var cep = obj.address_components[5].short_name;
								console.log(cep);
							} else {
								if(obj.address_components[6].types[0]="postal_code") {
									var cep = obj.address_components[6].short_name;
									console.log(cep);
								} else {
									if(obj.address_components[7].types[0]="postal_code") {
										var cep = obj.address_components[7].short_name;
										console.log(cep);
									} else {
										if(obj.address_components[8].types[0]="postal_code") {
											var cep = obj.address_components[8].short_name;
											console.log(cep);
										} else {
